...
### Added
- Placeholder for upcoming changes; add entries here under Added/Changed/Fixed/Removed
...
### Added
- Offline assets guide at `docs/user-guide/LOCAL_ASSETS.md` and link from README
- Documentation index at `docs/INDEX.md` (sitemap of key docs)
- Pull request template with changelog checklist

### Changed
- Repository-wide documentation sweep to replace stale commands with supported launchers
- README: clarified entry points and added Changelog & Releases section
- CONTRIBUTING: added changelog update rules and documentation standards

### Fixed
- Minor lints in `src/review/web_interface.py` and ensured `static/vendor/` creation
